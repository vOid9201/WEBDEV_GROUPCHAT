...
firebase.initializeApp({
  apiKey: "AIzaSyA3C9W8CCjc-wgOWsLttbpjTSbw6VkxfN8",
  authDomain: "askiiitl.firebaseapp.com",
  projectId: "askiiitl",
  storageBucket: "askiiitl.appspot.com",
  messagingSenderId: "645681592971",
  appId: "1:645681592971:web:08bb0fdde676e54d13328e",
  measurementId: "G-E1WW1DQ89V"
});
...
function App() {
  ...
  //   ? `${process.env.PUBLIC_URL}/theme.png`
  //   : `${process.env.PUBLIC_URL}/theme.png`;
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <img src={theme} alt="AlterClass" width={150} />
